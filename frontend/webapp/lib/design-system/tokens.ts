// Design System Tokens for Car History Report Application

// Color Palette - Automotive Industry Focus
export const colors = {
  ...
  warning: {
    ...
    300: '#fcd34d',
    400: '#fbbf24',
    500: '#f59e0b', // Caution/Warning status
    600: '#d97706',
    700: '#b45309',
    800: '#92400e',
    900: '#78350f',
  ...
  error: {
    ...
    300: '#fca5a5',
    400: '#f87171',
    500: '#ef4444', // Critical/Error status
    600: '#dc2626',
    700: '#b91c1c',
    800: '#991b1b',
    900: '#7f1d1d',
  ...
  automotive: {
    steel: '#4a5568',      // Professional automotive steel
    chrome: '#cbd5e1',     // Chrome accent
    leather: '#8b4513',    // Premium leather brown
    carbon: '#2d3748',     // Carbon fiber black
    warning: '#ed8936',    // Automotive warning orange
    premium: '#2c5aa0',    // Premium automotive blue
  },
} as const;
